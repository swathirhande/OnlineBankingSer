...
%>
<table><%
int accoun=Integer.parseInt(request.getParameter("amount"));
UserDetails userDetails = (UserDetails) request.getSession().getAttribute("UserDetails");
boolean status=userDetails != null;
		...
		try {
		if(status==true){
			out.print("Welcome    " + userDetails.getUsername());
            ...
            ps2.setInt(1,userDetails.getAccNo());
			...
			PreparedStatement ps3=con3.prepareStatement("update NEWACCOUNT set amount=? where accountno='"+userDetails.getAccNo()+"'");
